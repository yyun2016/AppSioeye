   ...
   public void checkTowVideoLiveButtonAndLive() throws Exception {
     ...
     */
	    public void checkTwoLapseVideoLiveButtonAndLive(String VideoQuality,int timeLapse) throws Exception {
	        ...
	        GalleryAction.makeLapseSomeTime(1,timeLapse);
	        checkTowVideoLiveButtonAndLive();
	    }
	    
	    
	    public static void main(String[] args){
			new UiAutomatorHelper("AppSioeye", "one.hardware.Testcase.GalleryCase", "testCheckGalleryLiveWithScreenOffOn", "2");
		}
	    /*
	    case 1
	    ...
	    public void testCheckSlo_MoVideoLiveButton() throws Exception {
			...
			GalleryAction.makeSlo_MoSomeTime(5);
			GalleryAction.makeSlo_MoSomeTime(1);
	        checkTowVideoLiveButtonAndLive();
...
//	        if (common.findViewById2("Skip").exists()){
//	        	common.failcase(runcase);
//	        }
//	        UiDevice.getInstance().pressKeyCode(KeyEvent.KEYCODE_CAMERA);
//	        common.clickViewById("Yes");
//	        common.passcase();
//	        
//	        common.startLog( "*****End to run " + runcase + " *****");
//		} catch (Exception e) {
...
//	        common.findViewById2(GalleryPage.gallery_bitrate_custom_min).setText(small);
